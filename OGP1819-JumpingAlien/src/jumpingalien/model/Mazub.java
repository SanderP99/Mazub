...
//		}
	 ...
	 */
	private void updatePosition(double dt) {
		double newPosX = getXPositionActual() + getHorizontalSpeedMeters() * dt
				+ 0.5 * getHorizontalAcceleration() * dt * dt;
		double newPosY = getYPositionActual() + getVerticalSpeedMeters() * dt
		...
		if (getWorld() != null) {
			Mazub newMazub = new Mazub(newPosX, newPosY, xSize, ySize, newSpeedX, this.getMinSpeedMeters(),
					this.getMaxSpeedRunningMeters(), this.getMaxSpeedDuckingMeters(), true, getSpriteArray()[8]);
...
//				this.setXSize(getCurrentSprite().getWidth());
				...
				Mazub newMazub = new Mazub(getXPositionActual(), getYPositionActual(), newWidth, newHeight, 0,
						this.getMinSpeedMeters(), this.getMaxSpeedRunningMeters(), this.getMaxSpeedDuckingMeters(),
						true, this.getSpriteArray());
...
//				this.setXSize(getCurrentSprite().getWidth());
			...
			Mazub newMazub = new Mazub(getXPositionActual(), getYPositionActual(), newWidth, newHeight, 0,
					this.getMinSpeedMeters(), this.getMaxSpeedRunningMeters(), this.getMaxSpeedDuckingMeters(), true,
					this.getSpriteArray());
